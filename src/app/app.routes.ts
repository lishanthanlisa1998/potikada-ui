...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./components/affiliate/affiliate-login/affiliate-login')
        .then(m => m.AffiliateLogin)
  },
  {
    path: 'affiliate/register',
    loadComponent: () =>
      import('./components/affiliate/affiliate-register/affiliate-register')
        .then(m => m.AffiliateRegister)
  },
  {
    path: 'affiliate/dashboard',
    loadComponent: () =>
      import('./components/affiliate/affiliate-dashboard/affiliate-dashboard')
        .then(m => m.AffiliateDashboard)
  },
  {
    path: 'cart',
    loadComponent: () =>
  ...
  // ===== ADMIN =====
  {
    path: 'admin/login',
    loadComponent: () =>
      import('./components/admin/admin-login/admin-login')
        .then(m => m.AdminLogin)
  }
  ,
      ...
      },
  {
    path: 'admin',
    loadComponent: () =>
      import('./components/admin/admin-layout/admin-layout')
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./components/admin/product-form/product-form')
